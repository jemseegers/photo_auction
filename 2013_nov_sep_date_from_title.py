...
with open("2013_nov_results.json") as json_file:
...
with open('2013_nov_results_with_dates.json' , 'w') as f:
 	f.write(json.dumps(json_data, indent=4))

#print(artist_count)
# loop through the json file then update counts to count dictionary